...
describe('GalleryView Component', () => {
  ...
  test('shows no matches message when filter returns no results', () => {
    ...
    expect(screen.getByText(/seems like nothing matches your search/i)).toBeInTheDocument();
  });
  ...
  test('uses correct URL for API call', () => {
    ...
    setup();
    expect(mockedUseCachedFetch).toHaveBeenCalledWith('https://picsum.photos/v2/list');
  });
